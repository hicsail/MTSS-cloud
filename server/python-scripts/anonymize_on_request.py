...
def anonymize_csv(csv_path, requests):
...
def get_parser():
    ...
    parser.add_argument('--requests', default=None, type=str, help='path to anonymize request file')
    return parser
...
if __name__ == "__main__":
    ...
    result_pd = anonymize_csv(args.csv_path, json.loads(args.requests))
